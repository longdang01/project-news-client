        ...
        <>
          <HelmetProvider>
            <Helmet>
              ...
              <title>
                {post.metaTitle + " / Fragile - Blog, News and Magazine"}
              </title>
            </Helmet>
          </HelmetProvider>
          <div className="container single-content text-justify">
                ...
                <div className="col-md-6">
                  ...
                  <a href="author.html">
                    <span className="author-name font-weight-bold">
                      ...
                      Danh mục: {post.subCategory.subCategoryName}
                    </p>
                    <span className="mr-10">
                      Ngày đăng: {moment(post.published).format("DD/MM/YYYY")}
                    </span>
            ...
            {/* <!--end single header--> */}
            <figure className="image mb-30 m-auto text-center border-radius-10 flex justify-center">
              <img
            ...
            <div>
              <article className="entry-wraper mb-50">
                ...
                <div
                  ...
                  style={{ visibility: "visible", animate: "fadeIn" }}
                ...
                >
                  ...
                  where saluted while black dear so yikes as considering recast
                  to some crass until.
                </p>
                ...
                <p>
                  ...
                  <a href="#">nightingale</a> the instead exited expedient up
                  far ouch mellifluous altruistic and and lighted more instead
                  much when ferret but the.
                </p>
                <figure className="wp-block-gallery columns-3 wp-block-image">
                  ...
                  <figcaption>
                    <i className="ti-credit-card mr-5"></i>Image credit: Behance
                  </figcaption>
                </figure>
                ...
                <p>
                  ...
                  <a href="#">however</a> hawk yet oh scratched ostrich some
                  outside crud irrespective lightheartedly and much far amenably
                  that the elephant since when.
                </p>
                ...
                <p>
                  ...
                  ouch cuckoo coward in scratched undid together bit fumblingly
                  so besides salamander heron during the jeepers hello fitting
                  jauntily much smoothly globefish darn blessedly far so along
                  bluebird leopard and.
                </p>
                <blockquote>
                  <p>
                ...
                <p>
                  ...
                  while irksome far clung irrespective wailed more rosily and
                  where saluted while black dear so yikes as considering recast
                  to some crass until cow much less and rakishly overdrew
                  consistent for by responsible oh one hypocritical less bastard
                  hey oversaw zebra browbeat a well.
                </p>
                ...
                <p>
                  ...
                  slick cracked llama the much gecko yikes more squirrel sniffed
                  this and the the much within uninhibited this abominable a
                  blubbered overdid foresaw through alas the pessimistic.
                </p>
                <p>
                  Gosh jaguar ostrich quail one excited dear hello and bound and
                  the and bland moral misheard roadrunner flapped lynx far that
                ...
                <div
                  className="border-radius-10 border bg-white mb-30 p-30 wow fadeIn"
                  style={{ visibility: "visible", animate: "fadeIn" }}
                >
                ...
                <p>
                  Yet more some certainly yet alas abandonedly whispered
                  intriguingly well extensive one howled talkative admonishingly
                  below a rethought overlaid dear gosh activated less however
              ...
              >
                <div className="entry-meta meta-1 font-small color-grey float-left mt-10">
                  <span className="hit-count mr-15">
                    <i className="elegant-icon icon_comment_alt mr-5"></i>182
                    comments
                  </span>
                  <span className="hit-count mr-15">
                    <i className="elegant-icon icon_like mr-5"></i>268 likes
                  </span>
                ...
                <div className="post-module-3">
                  ...
                  <div className="loop-list loop-list-style-1">
                    <article
                      ...
                      style={{ visibility: "visible", animate: "fadeInUp" }}
                    >
