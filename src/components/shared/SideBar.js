                  ...
                  <div className="d-flex hover-up-2 transition-normal">
                    <div className="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                      <a className="color-white" href="single.html">
                        <img
                          src="template/assets/imgs/news/thumb-1.jpg"
                          alt=""
                        />
                      </a>
                    </div>
                ...
                <li className="mb-30">
                  <div className="d-flex hover-up-2 transition-normal">
                    <div className="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                      <a className="color-white" href="single.html">
                        <img
                          src="template/assets/imgs/news/thumb-2.jpg"
                          alt=""
                        />
                      </a>
                    </div>
                ...
                <li className="mb-30">
                  <div className="d-flex hover-up-2 transition-normal">
                    <div className="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                      <a className="color-white" href="single.html">
                        <img
                          src="template/assets/imgs/news/thumb-3.jpg"
                          alt=""
                        />
                      </a>
                    </div>
          ...
          <div className="sidebar-widget widget-ads">
            ...
            >
              <img
                ...
                src="template/assets/imgs/ads/ads-1.jpg"
                alt=""
              />
            </a>
          </div>
